...
for i in range(len(points_list[0,:])): #loop through each value of a in our list
    a = points_list[0,i]
    ...
    r2 = lambda t: ellipse_reg(t, a + da, B)
    w2_unreg = weight_function(ellipse_reg, ellipse_reg_d1, ellipse_reg_d2, a + da, B)
    ...
    dAda[i] = variation_area(r, w, delr, delw) / da
